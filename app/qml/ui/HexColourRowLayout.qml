...
//        readOnly: true // see tst_app::colourPickerHexField
        ...
        selectByMouse: true
        onAccepted: {
            canvas.editingContextManager[selector.currentPenPropertyName] = inputColour
        ...
        property color currentColour: canvas ? canvas.editingContextManager[selector.currentPenPropertyName] : Qt.rgba(0, 0, 0, 1)
